			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="account-settings">
						...
						?>
						<br />
						<input type="submit" name="invento-settings-savesettings" class="ni btn blue" value="Guardar Configuracion" />
					</form>
				</div>
			<div>
			<?php } ?>
...
Si no desea cambiar su contraseña, deje los siguientes cuadros vacíos</span>
			<div class="center">
				<div class="form">
			...
			if($role == 1) {
			?>
			<h2>Inventa Configuraciones </h2>
			<div class="center">
				<div class="form">
					<form method="post" action="" name="invento-settings">
						<div class="checkbox"><input type="checkbox" name="allow-namechange" value="y" <?php if($sitedata[0] == 'y') echo 'checked'; ?>/>
						  Permitir a los usuarios cambiar su nombre<br />
						</div>
						<div class="checkbox"><input type="checkbox" name="allow-emailchange" value="y" <?php if($sitedata[1] == 'y') echo 'checked'; ?>/>
						  Permitir a los usuarios cambiar su email <br />
						</div>
						<br />
					    <input type="submit" name="invento-settings-save" class="ni btn blue" value="Guardar Cambios" />
					</form>
				</div>
			</div>
			<?php } ?>
