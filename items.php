	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				?>
				<a href="" name="check-out-all" class="btn blue disabled fright"><i class="fa fa-arrow-up"></i>Controlar Productos</a>
				<a href="" name="check-in-all" class="btn green disabled fright"><i class="fa fa-arrow-down"></i>Registrar Productos</a>
			</div>
			...
			<table border="1" rules="rows" id="items">
				<thead>
					<tr>
						...
						<td width="10%">QTY</td>
						<td width="14%">Precio Unitario </td>
