...
/* Title of the site */
INSERT INTO `invento_settings`(`name`,`val`) VALUES('site_title', 'Inventa - %page%');

/* Site Logo URL */
INSERT INTO `invento_settings`(`name`,`val`) VALUES('site_logo', 'media/img/inventalogo.png');
...
/* Default user */
INSERT INTO `invento_users`(`username`,`password`,`name`,`email`,`role`) VALUES('jclavero', '9d38f11be6e0a8b9da2a9dfd8ed0d6f5', 'Juan Clavero', 'clavero@gmail.com', 1);
