...
<div id="header">
			<div class="left">
				<a href="home.php"><img src="media/img/inventalogo.png" width="150" height="50" alt="Inventa" /></a>
			...
			<div class="right">
				...
				?>
				<a href="settings.php" title="Settings">Configuracion</a>|
		...
		<div id="menu">
			<ul id="menuli">
				...
				if($headrole == 1 || $headrole == 2 || $headrole == 3){
				?>
					<li<?php if($_page == 2) { ?> class="active"<?php } ?>><a href="new-item.php" title="New Item"><i class="fa fa-plus"></i> Nuevo Item</a></li>
				<?php
				}
				?>
				
				<li<?php if($_page == 3) { ?> class="active"<?php } ?>><a href="items.php" title="Items"><i class="fa fa-list-ul"></i> Items</a></li>
				<li<?php if($_page == 4) { ?> class="active"<?php } ?>><a href="check-in.php" title="Check-In Item"><i class="fa fa-arrow-down"></i> Ingresar Item</a></li>
				<li<?php if($_page == 5) { ?> class="active"<?php } ?>><a href="check-out.php" title="Check-Out Item"><i class="fa fa-arrow-up"></i> Sacar Item</a></li>
				...
				?>
				<li<?php if($_page == 7) { ?> class="active"<?php } ?>><a href="categories.php" title="Categories"><i class="fa fa-folder"></i> Categorias</a></li>
			</ul>
		</div>